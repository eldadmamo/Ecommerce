...
const Orders = () => {
    ...
    return (
        <div className="px-2 lg:px-7 pt-5">
            <h1 className="text-[#1f2937] font-semibold text-lg mb-3">
                Orders
            </h1>
            <div className="w-full p-4 bg-gradient-to-r from-purple-600 to-blue-500 rounded-md">
                <Search setParPage={setParPage} setSearchValue={setSearchValue} searchValue={searchValue}/>
                 
                <div className="relative overflow-x-auto mt-5">
                    <table className="w-full text-sm text-left text-[#f1f5f9]">
                        <thead className="text-sm text-[#f1f5f9] uppercase border-b border-gray-700">
                            <tr>
                        ...
                        <tbody>
                            {
                                myOrders.map((d,i) => 
                                <tr key={i} className="bg-gradient-to-r from-purple-600 to-blue-500  bg-white hover:bg-gray-100">
