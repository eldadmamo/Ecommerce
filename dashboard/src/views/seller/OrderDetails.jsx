        ...
        <div className="px-2 lg:px-7 py-5">
            <div className="w-full p-4 bg-[#6a5fdf] rounded-md">
                <div className="flex justify-between items-center p-4">
                    ...
                    <select onChange={status_update} value={status} name="" id="" className="px-4 py-2 focus:border-indigo-500 outline-none bg-[#475569] border-slate-700 rounded-md text-[#d0d2d6]">
                    ...
                    <div className="flex flex-wrap">
                        <div className="w-[30%]">
                             <div className="pr-3 text-[#d0d2d6] text-lg">
                                ...
                                <div key={i} className="mt-4 flex flex-col gap-4 bg-[#8288ed] rounded-md">
