...
import { get_admin_message, get_seller_message, messageClear, send_message_seller_admin, updateAdminMessage, updateSellerMessage } from "../../store/Reducers/chatReducer";
                    ...
                    <div className={`w-[280px] h-full absolute z-10 ${show ? '-left-[16px]':'-left-[336px]'} md:left-0 md:relative transition-all`}>
                        <div className="w-full h-[calc(100vh-177px)] bg-[#9e97e9] md:bg-transparent overflow-y-auto">
                            ...
                            <Link key={i} to={`/admin/dashboard/chat-sellers/${s._id}`} className={`h-[60px] flex justify-start gap-2 items-center text-white px-2 py-2 rounded-md cursor-pointer ${sellerId === s._id ? 'bg-[#8288ed]': ''}]`}>
                              ...
                              <img className="w-[38px] h-[38px] border-white border-2 max-w-[38px] p-[2px] rounded-full" alt="" src={s.image} />
                        ...
                        <div className="flex justify-between items-center"> 
                            {
                                sellerId && <div className="flex justify-start items-center gap-3">
                                    <div className="relative">
                                    <img className="w-[45px] h-[45px] border-green border-2 max-w-[45px] p-[2px] rounded-full" alt="" src={currentSeller?.image} />
                            ...
                            <div onClick={()=>setShow(!show)} className="w-[35px] flex md:hidden h-[35px] rounded-sm bg-blue-500 shadow-lg hover:shadow-blue-500/50 justify-center items-center text-white">
                            <span><FaList/></span>
                            </div>
                        </div>
