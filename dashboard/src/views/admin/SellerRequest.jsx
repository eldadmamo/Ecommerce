                    ...
                    <tbody>
                      {
                       [1,2,3,4,5].map((d,i) => 
                         <tr className="border-b border-slate-700" key={i}>
                                            ...
                                            <td scope="row" className="py-2 px-4 font-medium whitespace-nowrap">T-Shirt</td>
                                            <td scope="row" className="py-2 px-4 font-medium whitespace-nowrap">eldadfikre456@gmail.com</td>
                                            ...
                                            <td scope="row" className="py-2 px-4 font-medium whitespace-nowrap">
                                                ...
                                                <Link to='/admin/dashboard/sellers/details/2' className="p-[6px] bg-green-500 rounded hover:shadow-lg hover:shadow-green-500/50">
                                                <FaEye />
                                                </Link>
