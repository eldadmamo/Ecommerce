...
class chatController{
   ...
   customer_message_add = async (req, res) => {
    ...
    try {
        ...
        responseReture(res, 201,{message})
    ...
    get_customers = async(req,res) => {
        ...
        try{
            ...
            responseReture(res,200,{customers:data.myFriends})
        } catch(error){
            console.log(error)
        }
    }
    ...
    get_customers_seller_message = async (req,res) => {
        ...
        try{
           ...
           responseReture(res,200,{messages, currentCustomer})
    ...
    get_sellers = async(req,res) => {
        ...
        try{
            ...
            responseReture(res,200,{sellers})
        } catch(error){
            console.log(error)
        }
    }
    ...
    seller_admin_message_insert = async (req,res) => {
        ...
        try{
            ...
            responseReture(res, 200, {message: messageData})
        } catch(error){
            console.log(error)
        }
    }
    ...
    get_admin_messages = async (req,res) => {
        ...
        try{
           ...
           responseReture(res,200,{messages, currentSeller})
