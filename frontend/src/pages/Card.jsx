    ...
    return (
        <div>
            ...
            <div className='w-[85%] lg:w-[90%] md:w-[90%] sm:w-[90%] mx-auto py-16'>
                ...
                {
                    card_products.length > 0 || outOfStock > 0 ? 
...

                                 {
...

                                    {
                                       ...
                                       <div className='flex sm:w-full gap-2 w-7/12'>
                                          <div className='flex gap-2 justify-start items-center'>
                                            <img className='w-[80px] h-[80px]' src={`http://localhost:5173/images/products/${i+1}.webp`} alt='' />
                                    ...
                                    <div className='flex justify-between w-5/12 sm:w-full sm:mt-3'>
                                        <div className='pl-4 sm:pl-0'>
                                            <h2 className='text-lg text-orange-500'>$233</h2>
...

                                 {
                                    ...
                                    <div className='flex flex-col gap-3'>
                                        <div className='bg-white p-4'>
                                            <h2 className='text-md text-green-500 font-semibold'>Out of Stock {outOfStock.length}</h2>
                                        </div>
