...
const Register = () => {
    ...
    return (
        <div>
             ...
             {
                loader && <div className="w-screen h-screen flex justify-center items-center fixed left-0 bg-[#38303033] z-[999]">
                    <FadeLoader/>
                </div>
             }
                        ...
                        <div>
                            <form onSubmit={register} className="text-slate-600">
                                <div className="flex flex-col gap mb-2">
                                    ...
                                    <input onChange={inputHandle} value={state.name} className="w-full px-3 py-2 border border-slate-200 outline-none focus:border-green-500 rounded-md" type="text" name="name" placeholder="Name" required />
                                </div>
