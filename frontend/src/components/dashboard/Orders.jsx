    ...
    return (
        <div className='bg-white p-4 rounded-md'>
            <div className='flex justify-between items-center'>
                ...
                <select className='outline-none px-3 py-1 border rounded-md text-slate-600' 
                ...
                <div className='relative overflow-x-auto rounded-md'>
                   <table className='w-full text-sm text-left text-gray-500 rounded-md'>
                        <thead className='text-xs text-gray-700 uppercase bg-gray-200'>
                           <tr>
                            <th className='px-6 py-3' scope=''>Order Id</th> 
                            <th className='px-6 py-3' scope=''>Prices</th> 
                            <th className='px-6 py-3' scope=''>Payment Status</th> 
                            <th className='px-6 py-3' scope=''>Order Status</th> 
                            <th className='px-6 py-3' scope=''>Action</th> 
                            </tr>
                        </thead>
                      <tbody>
                            {
