        ...
        <footer className="bg-[#f3f6fa]">
            <div className="w-[85%] flex flex-wrap mx-auto border-b py-16 md-lg:pb-10 sm:pb-6">
                ...
                <div className="flex flex-col gap-3">
                    <img className="w-[180px] h-[70px]" src="http://localhost:5173/images/logo-png.jpg" alt="logo" />
                    <ul className="flex flex-col gap-2 text-slate-600">
                        <li>Address: Addis Ababa, Ethiopia</li>
                        <li>Phone: +251987129863</li>
                        <li>Email: eldadfikre456@gmail.com</li>
                    </ul>
                </div>
                </div>
                ...
                <div className="w-5/12 lg:w-8/12 sm:w-full">
                      <div className="flex justify-center sm:justify-start sm:mt-6 w-full">
                        <div>
                            <h2 className="font-bold text-lg mb-2 flex items-center justify-center">Useful Link</h2>
                ...
                <div className="w-4/12 lg:w-full lg:mt-6">
                  <div className="w-full flex flex-col justify-start gap-5">
                    <h2 className="font-bold text-lg mb-2 flex items-center justify-center">Join Our Shop</h2>
                    <span>Get Email updated about tour latest and shop specials offers</span>
                    ...
                    <ul className="flex justify-start items-center gap-3">
                        <li> 
                            <a className="w-[38px] h-[38px] hover:bg-[#059473] hover:text-white flex justify-center items-center bg-white rounded-full" href="#">
                            <FaFacebookF/> 
                            </a>
                        </li>
                        <li> 
