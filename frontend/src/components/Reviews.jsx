        ...
        <div className="mt-8">
            <div className="flex gap-10 md-lg:flex-col">
                ...
                <div className="flex justify-start items-center gap-5">
                    ...
                    <div className="w-[200px] h-[14px] bg-slate-200 relative">
                        <div style={{width: `${Math.floor((100 * (rating_review[5]?.sum || 0)) / totalReview)}%`}}  className="h-full bg-[#Edbb0E] w-[0%]">
                            
                        </div>
                    </div>
                    <p className="text-sm text-slate-600 w-[0%]">{rating_review[5]?.sum}</p>
                </div>
            ...
            <h2 className="text-slate-600 text-xl font-bold py-2">Product Review ({totalReview})</h2>
            ...
            <div className="flex flex-col gap-8 pb-10 pt-4">
                ...
                {
                totalReview > 5 && <Pagination pageNumber={pageNumber} 
                setPageNumber={setPageNumber}  totalItem={totalReview} 
                parPage={parPage} 
